...
//    var completionHandler: ((Bool, String) -> Void)?
    ...
    static func canUseLocalAuthentication() -> Int32 {
    ...
    static func validateLocalAuthentication(handler: @escaping ((Bool, String ) -> Void)) {
    ...
    static func localAuthenticationAvailable() -> Bool {
    ...
    static func localAuthenticationConfigured() -> Bool {
    ...
    static func saveCredentials(credentials: Dictionary<String, String>) -> Bool {
        do {
    ...
    static func updateCredentials(value: String, key: String) -> Bool {
        var savedCred = self.getSavedCredentials()
        savedCred[key] = value
        return self.saveCredentials(credentials: savedCred)
    }
    
    static func getSavedCredentials() -> Dictionary<String, String> {
    ...
    static func removeSavedCredentials() -> Bool {
